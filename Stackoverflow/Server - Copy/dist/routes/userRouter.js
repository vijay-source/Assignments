...
userRouter.post("/registration", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, username, email, password, newUser;
    ...
    return __generator(this, function (_b) {
        ...
        User.findOne({ username: username })
            ...
            bcrypt.compare(password, user.password).then(function (isMatch) {
                ...
                jwt.sign({ id: user._id }, "" + process.env.jwtSecret, { expiresIn: 999999999999999 }, function (err, token) {
                    if (err)
                        throw err;
