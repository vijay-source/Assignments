...
var question_router_1 = __importDefault(require("../routes/question_router"));
var answerRouter_1 = __importDefault(require("../routes/answerRouter"));
...
function connectToDb() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    connStr = " mongodb+srv://" + process.env.DB_USER + ":" + process.env.DB_PASS + "@cluster0.s3eeb.mongodb.net/" + process.env.DB_DATABASE + "?retryWrites=true&w=majority";
