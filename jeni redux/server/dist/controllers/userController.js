...
var registerUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name_1, email, phoneNumber, password, userName, user_1, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, name_1 = _a.name, email = _a.email, phoneNumber = _a.phoneNumber, password = _a.password, userName = _a.userName;
            ...
            case 1:
                ...
                res
                    .status(200)
                    .send({ success: true, message: "Registration successful", user: user_1 });
                return [3 /*break*/, 3];
            case 2:
                err_1 = _b.sent();
                console.log("from register err.message", err_1.message);
                res.status(404).send({
                    success: false,
...
var loginUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, userName, password_1;
    return __generator(this, function (_b) {
        try {
            _a = req.body, userName = _a.userName, password_1 = _a.password;
            if (!userName || !password_1) {
                return [2 /*return*/, res
                        .status(400)
                        .json({ message: "credentials are not matched", success: false })];
            }
            userSchema_1.default.findOne({ userName: userName }).then(function (user) {
                if (!user) {
                    return res
                        .status(400)
